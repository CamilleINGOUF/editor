...
public class DocumentTest extends TestCase {
    ...
    public void testSelect() throws Exception {
        ...
        assertTrue(Util.select(new Point(1,1), 8, document).size() == 1);
        assertTrue(Util.select(new Point(1,1), 8, document).firstElement().getID() == c.getID());
    }
    ...
    public void testSelect2() throws Exception {
        ...
        assertTrue(Util.select(new Point(1,1), 8, document).size() == 2);
    }
    ...
    public void testJSON() throws Exception {
        ...
        */
        assertEquals(JSONBuilder.toJson(document), "{ type: document, layers: { { type: layer, objects : { { type: square, center: " +
                "{ type: point, x: 0.0, y: 0.0 }, length: 5.0 }, { type: circle, center: { type: point, x: 5.0, y: 5.0 }" +
    ...
    public void testConstructorGrid() throws Exception {
        Document document = DocumentBuilder.BuildDocument(new Point(0,0), 3, 3, 5);
    ...
    public void testConstructorCircle() throws Exception {
        assertEquals(DocumentBuilder.BuildDocument(new Point(0,0), 4, 3., 4.).getObjectNumber(), 4);
    }
}