...
public class DocumentBuilder {
    public static Document BuildDocument(Point origin, int line, int column, double length)
    {
    ...
    public static Document BuildDocument(Point center, int number, double radius, double delta)
    {
        Document document = new Document();
